...
public interface StationResourcesPubApi {
    ...
    @PostMapping("/row/{stationSpaceId}/available")
    MyListResponse<StationResourceKeyValueResponse> findAvailableByDateAndTimeIn(@PathVariable Long stationSpaceId,
            @RequestBody @Valid StationResourceAvailableRequest request);
}
